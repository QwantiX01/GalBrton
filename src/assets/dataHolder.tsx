export const headerLinks = [
    ...
    {content: "Продукти", link: "/products"},
    {content: "Проєкти", link: "#"},
    {content: "Про нас", link: "#"},
    {content: "З'єднатися з наMи", link: "/contact", outline: true},
];
export const filters = [{title: "All", id: 0}, {title: "Production", id: 1}, {title: "Service", id: 2}]
